...
# --- СПИСКИ ДАНИХ ---
CATASTROPHES_DATA = [
    {"name": "🌋 Ядерна зима", "desc": "Радіоактивний попіл закрив сонце. Температура впала до -50°C. Рослини гинуть, а виживання можливе лише в герметичних бункерах.", "range": (20, 50)},
    {"name": "🧟 Зомбі-апокаліпсис", "desc": "Невідомий вірус перетворив 99% населення на агресивних монстрів. Потрібно перечекати кілька років, поки мертві тіла остаточно розкладуться.", "range": (2, 7)},
    {"name": "🌊 Всесвітній потоп", "desc": "Через танення льодовиків рівень океану піднявся на сотні метрів. Суходолу майже не залишилося, ресурси на вагу золота.", "range": (10, 20)},
    {"name": "👽 Нашестя іншопланетян", "desc": "Земля окупована високотехнологічною расою. Бункер захищений екранами, що приховують тепло людей від сканерів загарбників.", "range": (5, 15)},
    {"name": "☀️ Сонячний спалах", "desc": "Потужний викид енергії спалив озоновий шар. Рівень радіації на поверхні смертельний, вся електроніка виведена з ладу.", "range": (4, 10)},
    {"name": "❄️ Льодовиковий період", "desc": "Орбіта Землі змінилася, і планета вкрилася товстим шаром криги. Поверхня непридатна для життя на довгі десятиліття.", "range": (50, 100)},
    {"name": "☣️ Пандемія", "desc": "Штучно створений вірус передається повітряно-крапельним шляхом. Вакцини немає, а будь-який контакт із зовнішнім повітрям фатальний.", "range": (1, 3)}
]

BUNKER_TYPES = [
    "🥚 Інкубаторний (технологія штучного вирощування людей, стать не важлива)",
...
async def process_code(message: types.Message, state: FSMContext):
    ...
    response = (f"🚨 **ВИ У ГРІ #{game_id}**\n\n"
                ...
                f"📖 **Опис:** {g['cat_desc']}\n"
                f"⏳ **Термін виживання:** {g['stay_time']} років\n\n"
                f"🛡 **БУНКЕР:** {g['bunker']}\n"
                f"⚠️ **СТАН:** {g['prob']}\n"
                f"------------------------------\n"
                f"💼 **ВАША КАРТКА:**\n"
