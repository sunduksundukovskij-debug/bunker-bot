...
PROFESSIONS = [
    "Лікар", "Агроном", "Інженер", "Кухар", "Програміст", "Електрик", "Вчитель", "Будівник", 
...
HOBBIES = ["Стрільба", "Гітара", "Садівництво", "Виживання", "Бокс", "Малювання", "Риболовля", "Паркур", "Кулінарія", "Йога", "Хімія"]

BAGGAGE = [
    "Ніж", "Аптечка", "Насіння", "Рація", "Ліхтарик", "Рушниця", "Протигаз", "Набір (Юний Хімік)","Еліксир Молодості(-10р)", 
    "Гітара", "Інструменти", "Запальничка", "Компас","ЛУк та стріли", "Інгалятор", 
...
SECRET_GOALS = [
    ...
    "🤫 Мета: Вигнати будь-кого '40+ років'.",
    "🤫 Мета: Вижити будь-якою ціною.",
    "🤫 Мета: Вижити.",
    "🤫 Мета: Немає.",
    "🤫 Мета: Взяти в бункер людину з найгіршим здоров'ям.",
    "🤫 Мета: Зробити так, щоб у бункері було 2 жінки або 2 чоловіка.",
...
RANDOM_EVENTS = [
    ...
    "⚠️ ПОДІЯ: Аномальна зона! Кожен гравець має змінити свою Фобію проти часової стрілки.",
    "⚠️ ПОДІЯ: Мутація! Кожен гравець змінює свою стать.",
    "⚠️ ПОДІЯ: Психологічна атака! Кожен має відкрити свою Секретну мету.",
